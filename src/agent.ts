...
2. EFFICIENCY: LLM tokens are EXPENSIVE. Local CPU is practically FREE. Be lean.
   ...
   - A clean workspace is a cheap workspace. Clutter burns tokens.
...
- Tasks: workspace/tasks/ - Your active task backlog.
  Each folder contains: request.md (what user asked), plan.md (your plan), progress.md (current status).
  NEW TASK: Create folder, write request.md, create plan.md before starting work.
  ON STARTUP: Scan tasks. If multiple in_progress, ask user which to prioritize.
  BEFORE REPLYING: Update progress.md with what you accomplished.
